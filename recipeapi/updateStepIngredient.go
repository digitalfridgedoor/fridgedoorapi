...
// AddIngredient adds a method step scoped ingredient
func (editable *EditableRecipe) AddStepIngredient(ctx context.Context, stepIdx int, ingredientID *primitive.ObjectID) (*Recipe, error) {
...
// UpdateIngredient updates a method step scoped ingredient
func (editable *EditableRecipe) UpdateStepIngredient(ctx context.Context, stepIdx int, ingredientID string, updates map[string]string) (*Recipe, error) {
...
// RemoveIngredient removes a method step scoped ingredient
func (editable *EditableRecipe) RemoveStepIngredient(ctx context.Context, stepIdx int, ingredientID string) (*Recipe, error) {
